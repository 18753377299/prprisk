...
/**
 * POJO Class ExcelTestTemp
 */
@Entity
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@Table(name = "EXCEL_TEST_TEMP")
public class ExcelTestTemp implements java.io.Serializable {
	...
	@Id
	@Column(name = "ROW_ID", unique = true, nullable = false, precision=18, scale=0)
