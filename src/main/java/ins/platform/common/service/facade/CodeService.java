...
public interface CodeService {
	 ...
	 * @return 代码名称
	 */
	// public String translateCode(String codeType, String codeCode, String
	// riskCode, String language);
	 ...
	 * @return 代码名称
	 */
	// public List<Code> listCodeList(String codeType, String riskCode, String
	// language);
	 ...
	 * @return 代码List
	 */
	// public Page listCodeSelect(String codeType, String riskCode, String
	// language, String matches, int pageNo,
