...
public class SaaDataPowerServiceSpringImpl implements SaaDataPowerService{
	private static final Logger LOGGER = LoggerFactory.getLogger(SaaDataPowerServiceSpringImpl.class);
...
//	@Autowired  
	...
	public KeyValueVo processFind(String queryString, Object... params){
		...
		KeyValueVo keyValueVo = new KeyValueVo(queryString, paramsList.toArray());
		return keyValueVo;
	}
