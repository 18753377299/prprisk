...
<html lang="en">
<head>
<title><fmt:message key="label.home.sys.identity.authorization" /></title>
</head>
<body>
	<div class="row">
		<div class="col-lg-12">
			<ol class="breadcrumb">
				...
				<fmt:message key="label.home.sys.identity.authorization"/>		
						</li>
			</ol>
		</div>
		<div class="col-lg-12">
						...
						<h4 class="panel-title">
							<a data-toggle="collapse" data-parent="#accordion"
								href="#collapseOne"><fmt:message
									key="label.grantlist.grantlist" /></a>
						</h4>
					</div>
									...
									<tbody>
										<c:forEach var="vo" items="${sysUsers }">
											<tr>
												...
												<td>
													<!-- 如果要更改"授予身份"四个字，需要同步修改该页面对应的js文件 --> <a
													id="${ctx }/runas/grant/${vo.userCode}" href=""><fmt:message
															key="label.grantlist.grant" /></a>
												</td>
											</tr>
										</c:forEach>
									</tbody>
	...
	<!-- /.row -->
	<script src="${ctx}/${app_version}/runas/js/GrantList.js"></script>
</body>
</html>