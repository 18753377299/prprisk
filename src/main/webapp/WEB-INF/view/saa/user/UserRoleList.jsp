...
<body>
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					<h4 class="panel-title">
						...
						<button type="button" class="btn btn-primary btn-sm btn-edit role">
							用户角色管理
						</button>
						<button type="button" class="btn btn-primary btn-sm btn-edit power">
							用户业务权限管理
						</button>
	...
	<script src="${ctx}/${app_version}/saa/user/js/UserRoleList.js"></script>
</body>
</html>