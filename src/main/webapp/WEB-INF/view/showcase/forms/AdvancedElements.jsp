...
<!-- daterange picker -->
<link
	href="${ctx}/static/adminlte/${adminlte_version}/plugins/daterangepicker/daterangepicker-bs3.css"
	rel="stylesheet">
<!-- iCheck for checkboxes and radio inputs -->
<link
	href="${ctx}/static/adminlte/${adminlte_version}/plugins/iCheck/all.css"
	rel="stylesheet">
<!-- Bootstrap Color Picker -->
<link
	href="${ctx}/static/adminlte/${adminlte_version}/plugins/colorpicker/bootstrap-colorpicker.min.css"
	rel="stylesheet">
<!-- Bootstrap time Picker -->
<link
	href="${ctx}/static/adminlte/${adminlte_version}/plugins/timepicker/bootstrap-timepicker.min.css"
	rel="stylesheet">
<!-- Select2 -->
<link
	href="${ctx}/static/adminlte/${adminlte_version}/plugins/select2/select2.min.css"
	rel="stylesheet">
<!-- Theme style -->
...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<!-- Select2 -->
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/select2.full.min.js"
		type='text/javascript' charset="utf-8"></script>
	<!-- InputMask -->
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/input-mask/jquery.inputmask.js"
		type='text/javascript' charset="utf-8"></script>
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/input-mask/jquery.inputmask.date.extensions.js"
		type='text/javascript' charset="utf-8"></script>
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/input-mask/jquery.inputmask.extensions.js"
		type='text/javascript' charset="utf-8"></script>
	<!-- date-range-picker -->
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/daterangepicker/moment.min.js"></script>
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/daterangepicker/daterangepicker.js"
		type='text/javascript' charset="utf-8"></script>
	<!-- bootstrap color picker -->
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/colorpicker/bootstrap-colorpicker.min.js"
		type='text/javascript' charset="utf-8"></script>
	<!-- bootstrap time picker -->
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/timepicker/bootstrap-timepicker.min.js"
		type='text/javascript' charset="utf-8"></script>
	<!-- SlimScroll 1.3.0 -->
	<!-- iCheck 1.0.1 -->
	<script
		src="${ctx}/static/adminlte/${adminlte_version}/plugins/iCheck/icheck.min.js"
		type='text/javascript' charset="utf-8"></script>
	<!-- FastClick -->
	<!-- AdminLTE App -->
