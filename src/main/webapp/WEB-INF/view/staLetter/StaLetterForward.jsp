...
<body>
										...
										<div class="row form-group">
											...
											<div class="col-xs-4">
												<input id="receiver" onblur="checkReceiver(this.value)"
													...
													name="receiver" /> <span id="errormsg"></span>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-lg-4 col-md-6 col-xs-12">
										<div class="row form-group control-group">
											...
											<div class="col-xs-4">
												...
												<!--<textarea id="theme" cols="120" rows="1" name="theme">${staLetter.theme}</textarea>-->
											</div>
	...
	<script src="${ctx}/staLetter/js/StaLetterReceiveList.js"></script>
