...
<body>
									...
									<div class="col-lg-4 col-md-6 col-xs-12">
										<div class="row form-group">
											<div class="col-xs-6">
												...
												<%-- 隐藏的控制条件 --%>
												<input name="[form][areaName][dataType]" type="hidden"
													value="String" /> <input
													name="[form][areaName][queryType]" type="hidden"
													value="begin with" />
											</div>
											<div class="col-xs-6">
												<input id="id" name="[form][areaName][value]"
							...
							<table width="100%"
								...
								<thead>
									<tr>
										...
										<th><fmt:message key="label.sysAreaDict.list.areacode" /></th>
										<th><fmt:message key="label.sysAreaDict.list.areaname" /></th>
										<th><fmt:message key="label.sysAreaDict.list.fullname" /></th>
										<th><fmt:message key="label.sysAreaDict.list.arealevel" /></th>
										<th><fmt:message key="label.sysAreaDict.list.postCode" />/th>
	...
	<!-- /.row -->
	<script src="${ctx}/${app_version}/sysAreaDict/js/SysAreaDictList.js"></script>
</body>
</html>