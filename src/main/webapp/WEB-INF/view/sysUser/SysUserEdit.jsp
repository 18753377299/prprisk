		...
		<div class="col-lg-12">
			...
			<form id="form" class="form-horizontal" role="form" method="post">
				<input type="hidden" id="editMode"  name="editMode"
					value="${editMode}"></input> <input type="hidden" name="checked"
					value="${sysUser.checked}"></input> <input type="hidden"
					name="salt" value="${sysUser.salt}"></input> <input type="hidden"
					name="validStatus" value="${sysUser.validStatus}"></input> <input
					id="id" name="id" class="form-control" type="hidden"
										...
										<div class="form-group">
											...
											<div class="col-xs-8">
												<input id="mobilePhone" name="mobilePhone"
													...
													value="${sysUser.mobilePhone}" data-inputmask="'mask': '99999999999'" data-mask>
											</div>
										</div>
									</div>
									<div class="col-md-6 col-xs-12">
										...
										<div class="form-group">
											...
											<div class="col-xs-8">
												<input id="postCode" name="postCode" class="form-control"
													type="text" value="${sysUser.postCode}" data-inputmask="'mask': '999999'" data-mask>
											</div>
										</div>
									</div>
						...
						<div class="panel panel-info">
							...
							<div id="collapse2" class="panel-collapse collapse in">
								<div class="panel-body">
									<div class="row">
				<!-- 密码输入开始-->
				                  <div id="passwordZone" readonly="" hidden="">
										<div class="col-md-6 col-xs-12">
											<div class="form-group">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="text-center">
                                       		<button type="button" class="btn btn-info btn-edit" display="none" id="modifyPassword">
								         		  修改密码
												</button>
