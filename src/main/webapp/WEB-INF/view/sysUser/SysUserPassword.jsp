					...
					<div class="row">
						<div class="col-lg-10">
							<div class="row form-group">
								...
								<div class="col-xs-8">
									<input id="userCode" name="userCode" type="text" class="form-control" readonly="true" value="${sysUser.userCode}"/>
								</div>
							</div>
						</div>
						<div class="col-lg-2">
					...
					<div class="row">
						<div class="col-lg-10">
							<div class="row form-group">
								...
								<div class="col-xs-8">
									<input id="password" name="sysUser.password" type="password" class="form-control" placeholder="请输入原始密码" readonly="readonly"  value="${sysUser.password}/>
								</div>
								</div>
							</div>
						</div>
